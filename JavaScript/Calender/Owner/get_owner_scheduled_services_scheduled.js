var baseUrl = 'https://secure.petexec.net/api';
	...
	$('#submitButton').on('click', getScheduledServices);

	function getScheduledServices(e) {
		e.preventDefault();
		...
		var userid = ''; // Enter User Id here

		$.ajax({
			type : 'GET',
			url : baseUrl + '/calendar/owner/' + userid + '/scheduled-service/start/' + start_date +'/end/' + end_date,
			dataType : 'json',
			headers : {
