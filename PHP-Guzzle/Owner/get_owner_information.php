...
<head>
  ...
  <title>Get Owner Information</title>
  <meta name="viewport" content="width=device-width, initial-scale=1">
</head>
<body>
  <h1>Get Owner Information</h1>
  <?php 
    ...
    try {    
      ...
      $ownerID = ''; // Enter id of owner
      $desiredScope = 'owner_read'; //Enter desired scope/s in space separated list
      // ---------------------------------
