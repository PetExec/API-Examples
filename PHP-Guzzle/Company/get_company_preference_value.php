...
try {
    ...
    $params = array(
        ...
        'username'      => $username,
        'password'      => $password,
        'scope'         => 'preference_read'//Enter the scopes that you're wanting to request in a space seperated list,
    ...
    $get_response = $client->request('get', 'preference/' . $preference_name , ['headers' => ['Authorization' => 'Bearer ' . $access_token]]);
