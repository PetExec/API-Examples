...
<head>
  ...
  <title>Get Purchase History</title>
  <meta name="viewport" content="width=device-width, initial-scale=1">
</head>
<body>
  <h1>Get Purchase History</h1>
  <?php 
    ...
    try {    
      ...
      $ownerID = ''; // Enter desired ownerId
      $desiredScope = 'purchase_read'; //Enter desired scope in space separated list
      // ---------------------------------
      ...
      // Retrieve owner purchase history
      $custom_endpoint = 'purchase-history/owner/' . $ownerID;
