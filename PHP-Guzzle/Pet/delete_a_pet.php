...
<body>
  ...
  <?php 
    ...
    try {    
      ...
      $desiredScope = 'pet_delete'; //Enter desired scope/s in space separated list
      // ---------------------------------
      ...
      $get_response = $client->request('delete', $custom_endpoint, ['headers' => ['Authorization' => 'Bearer ' . $access_token]]);
