...
try {
    ...
    $params = array(
        ...
        'username'      => $username,
        'password'      => $password,
        'scope'         => 'pet_delete'//Enter the scopes that you're wanting to request in a space seperated list,
    ...
    $petID = '';
    $get_response = $client->request('delete', 'pet/' . $petID, ['headers' => ['Authorization' => 'Bearer ' . $access_token]]);
