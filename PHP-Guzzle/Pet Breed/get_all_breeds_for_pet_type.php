...
try {
    ...
    $params = array(
        ...
        'username'      => $username,
        'password'      => $password,
        'scope'         => 'breed_read'//Enter the scopes that you're wanting to request in a space seperated list,
    ...
    $get_response = $client->request('get', 'breed/pet-type' . $PetTypeID, ['headers' => ['Authorization' => 'Bearer ' . $access_token]]);
