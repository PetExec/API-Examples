...
try {
    ...
    $params = array(
        ...
        'username'      => $username,
        'password'      => $password,
        'scope'         => 'daycare_delete'//Enter the scopes that you're wanting to request in a space seperated list,
    ...
    $get_response = $client->request('delete', 'daycare/' . $daycareID, ['headers' => ['Authorization' => 'Bearer ' . $access_token]]);
