...
try {
    ...
    $params = array(
        ...
        'username'      => $username,
        'password'      => $password,
        'scope'         => 'scheduled_service_read'//Enter the scopes that you're wanting to request in a space seperated list,
    ...
    $get_response = $client->request('get', 'scheduled-service/services/' . $serviceid, ['headers' => ['Authorization' => 'Bearer ' . $access_token]]);
