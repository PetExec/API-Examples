...
try {
    ...
    $params = array(
        ...
        'username'      => $username,
        'password'      => $password,
        'scope'         => 'boarding_read'//Enter the scopes that you're wanting to request in a space seperated list,
    ...
    $get_response = $client->request('get', 'boarding/packages/owner/' . $ownerID, ['headers' => ['Authorization' => 'Bearer ' . $access_token]]);
