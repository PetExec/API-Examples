...
try {
    ...
    $params = array(
        ...
        'username'      => $username,
        'password'      => $password,
        'scope'         => 'boarding_delete'//Enter the scopes that you're wanting to request in a space seperated list,
    ...
    $boardingID = '';
    $get_response = $client->request('delete', 'boarding/' . $boardingID, ['headers' => ['Authorization' => 'Bearer ' . $access_token]]);
