...
try {
    ...
    $params = array(
        ...
        'username'      => $username,
        'password'      => $password,
        'scope'         => 'shot_delete'//Enter the scopes that you're wanting to request in a space seperated list,
    ...
    $get_response = $client->request('DELETE', 'shot/' . $shot_id, ['headers' => ['Authorization' => 'Bearer ' . $access_token]]);
