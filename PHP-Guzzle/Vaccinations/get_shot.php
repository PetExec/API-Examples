...
try {
    ...
    $params = array(
        ...
        'username'      => $username,
        'password'      => $password,
        'scope'         => 'shot_read'//Enter the scopes that you're wanting to request in a space seperated list,
    ...
    $get_response = $client->request('GET', 'shot/pet-type/' . $pet_id, ['headers' => ['Authorization' => 'Bearer ' . $access_token]]);
